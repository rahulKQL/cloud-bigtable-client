...
public class TestBigtableWhileMatchResultScannerAdapter {
  ...
  @Mock private ResponseAdapter<Row, Result> mockRowAdapter;

  @Mock com.google.cloud.bigtable.grpc.scanner.ResultScanner<Row> mockBigtableResultScanner;
  ...
  public void adapt_oneRow() throws IOException {
    Row row = Row.create(ByteString.copyFromUtf8("key"), ImmutableList.<RowCell>of());
