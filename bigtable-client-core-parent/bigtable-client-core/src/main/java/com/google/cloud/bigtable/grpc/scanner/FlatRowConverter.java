...
public class FlatRowConverter {
  ...
  public static com.google.cloud.bigtable.data.v2.models.Row convertToModelRow(FlatRow flatRow){
    if(flatRow == null){
      return null;
    }
    ...
    return com.google.cloud.bigtable.data.v2.models.Row.create(flatRow.getRowKey(), rowCellList);
  }

  private static com.google.cloud.bigtable.data.v2.models.RowCell toRowCell(FlatRow.Cell cell){
    return com.google.cloud.bigtable.data.v2.models.RowCell.create(cell.getFamily(),
        cell.getQualifier(), cell.getTimestamp(), cell.getLabels(), cell.getValue());
  }
}